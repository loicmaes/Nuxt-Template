...
<template>
  <div class="w-full min-h-dvh flex flex-col gap-4 items-center justify-center">
    <header class="flex flex-col items-center gap-4">
      ...
      <div class="flex items-center flex-row-reverse gap-4 self-center">
        ...
        >
          <NuxtLink
            to="https://github.com/loicmaes/Nuxt-Template"
            target="_blank"
          >
            <Code />
            <span>{{ t("temp.welcome.visitDoc") }}</span>
          </NuxtLink>
        </Button>
      </div>
    </header>
